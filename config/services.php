...
return [
    ...
    */
    ...
    'mybidhaa' => [
        'base_url' => env('MYBIDHAA_API_BASE_URL', 'https://mybidhaa.com/api/v1'),
        // Cache TTL (seconds) for public product listings to respect rate limits
        'cache_ttl' => env('MYBIDHAA_PRODUCT_CACHE_TTL', 60),
    ],
];
