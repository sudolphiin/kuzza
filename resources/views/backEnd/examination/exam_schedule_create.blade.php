                                ...
                                <thead>
                                    <tr>
                                        ...
                                        @foreach ($exam_periods as $exam_period)
                                            <th>{{ @$exam_period->period }}<br>{{ date('h:i A', strtotime(@$exam_period->start_time)) . '-' . date('h:i A', strtotime(@$exam_period->end_time)) }}
                                            </th>
                                        @endforeach
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    @foreach ($assign_subjects as $assign_subject)
                                        <tr>
                                            ...
                                            <td>{{ @$assign_subject->class != '' ? @$assign_subject->class->class_name : '' }}({{ @$assign_subject->section != '' ? @$assign_subject->section->section_name : '' }})
                                            </td>
                                            @foreach ($exam_periods as $exam_period)
                                                @php
                                                    $assigned_routine = App\SmExamSchedule::assignedRoutine(
                                                        $class_id,
