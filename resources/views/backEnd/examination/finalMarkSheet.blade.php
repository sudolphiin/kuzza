            ...
            @isset($students)
                <div class="row mt-40">
                    <div class="col-lg-12">
                                ...
                                @if ($attendance_type != 'H')
                                    <form action="{{ route('student-attendance-holiday') }}" method="POST">
                                        ...
                                        @if (moduleStatusCheck('University'))
                                            ...
                                            <input type="hidden" name="un_section_id"
                                                value="{{ isset($unSection) ? $unSection->id : '' }}">
                                        @endif
                        ...
                        {{ html()->form('POST', route('student-attendance-store'))->attributes([
                                'class' => 'form-horizontal',
                                'files' => true,
                                'enctype' => 'multipart/form-data',
                            ])->open() }}
                                            ...
                                            <tr>
                                                <td>{{ $student->studentDetail->admission_no }}
                                                    ...
                                                    @if (moduleStatusCheck('University'))
                                                        ...
                                                        <input type="hidden"
                                                            name="attendance[{{ $student->id }}][un_section_id]"
                                                ...
                                                <td>
                                                    <div class="primary_input">
                                                        <textarea class="primary_input_field form-control note_{{ $student->id }}" cols="0" rows="2"
                                                            name="attendance[{{ $student->id }}][note]" id="">{{ $student->studentDetail->DateWiseAttendances != null ? $student->studentDetail->DateWiseAttendances->notes : '' }}</textarea>
