                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="ml-30">
                                                        <h3 class="text-white"> {{isset($school_name)?$school_name:'Kuzza School Management ERP'}} </h3>
                                                        <p class="text-white mb-0"> {{isset(generalSetting()->address)?generalSetting()->address:'Kuzza School Address'}} </p>
                                                    </div>
                                                </div>
                                            </div>
