                                        ...
                                        <tbody>
                                            @foreach ($student_records as $record)
                                                <tr>
                                                    ...
                                                    <td>{{ @$record->feesInstallments->sum('amount') - (@$record->feesInstallments->sum('paid_amount') - @$record->feesInstallments->sum('discount_amount')) }}
                                                    </td>
                                            ...
                                            <tbody>
                                                @foreach ($records as $record)
                                                    <tr>
                                                        ...
                                                        <td>{{ @$record->directFeesInstallments->sum('discount_amount') }}
                                                        </td>
                                                        <td>{{ @$record->directFeesInstallments->sum('paid_amount') }}</td>
                                                        <td>{{ @$record->directFeesInstallments->sum('amount') - (@$record->directFeesInstallments->sum('paid_amount') - @$record->directFeesInstallments->sum('discount_amount')) }}
                                                        </td>
