                                                        ...
                                                        <td>
                                                            @php
                                                                if ($fees_discount->type == 'once') {
                                                                    $checkPayment = App\SmFeesDiscount::CheckAppliedDiscount(
                                                                        $fees_discount_id,
                                                                        $student->id,
                                                                        $student->id,
                                                                    );
                                                                    ...
                                                                    $checkPayment = App\SmFeesDiscount::CheckAppliedYearlyDiscount(
                                                                        $fees_discount_id,
                                                                        $student->id,
                                                                        $student->id,
                                                                    );
                                                                ...
                                                                @if ($check_discount_apply == '')
                                                                    <select
                                                                        ...
                                                                        <option data-display="@lang('fees.select_fees_type') *"
                                                                            value="">@lang('fees.select_fees_type') *</option>
                                                                        @foreach ($assigned_fees_groups[$student->id] as $key => $fees_group)
                                                                            ...
                                                                            @php
                                                                                $studentAssingFees_types = App\SmFeesAssign::studentFeesTypeDiscount(
                                                                                    $fees_group->group_id,
                                                                                    $student->student_id,
