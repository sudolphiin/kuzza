                                                        ...
                                                        <ul class="list-unstyled mb-2">
                                                            @foreach($items as $item)
                                                                <li class="d-flex justify-content-between align-items-center py-1 border-bottom">
                                                                    <span>
                                                                        {{ optional($item->recommendedItem)->item_name ?? 'Item' }}
                                                                        <span class="badge badge-light text-muted">{{ ucfirst($item->status) }}</span>
                                                                        @if($item->notes)
                                                                            <span class="text-muted small d-block">Reason: {{ $item->notes }}</span>
                                                                        @endif
                                                                    </span>
