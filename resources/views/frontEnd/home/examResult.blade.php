@php $page_title="All about Kuzza School management system; School management software"; @endphp
                                                        ...
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="col-lg-8 text-center">
                                                                <h3 class="text-white"
                                                                    ...
                                                                    {{ isset(generalSetting()->school_name) ? generalSetting()->school_name : 'Kuzza School Management ERP' }}
                                                                </h3>
                                                                <p class="text-white mb-0" style="font-size: 16px;">
                                                                    {{ isset(generalSetting()->address) ? generalSetting()->address : 'Kuzza School Address' }}
                                                                </p>
                                                                <p class="text-white mb-0" style="font-size: 16px;">
