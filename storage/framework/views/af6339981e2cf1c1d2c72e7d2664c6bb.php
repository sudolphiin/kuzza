...
<?php if(! $kuzzaLogoIsSvg): ?>
<link rel="preload" href="<?php echo e($kuzzaLogoUrl); ?>" as="image" type="<?php echo e($kuzzaLogoMime); ?>">
<?php endif; ?>
    ...
    <div class="header-top-inner">
      <div class="nav-logo">
        <a href="#hero" class="nav-logo-link" style="display:flex;align-items:center;gap:0.65rem;text-decoration:none;color:inherit">
          <?php if($kuzzaLogoSvgInline !== ''): ?>
            <span class="nav-logo-svg-wrap" role="img" aria-label="KUZZA"><?php echo $kuzzaLogoSvgInline; ?></span>
          <?php else: ?>
            <img src="<?php echo e($kuzzaLogoUrl); ?>" alt="KUZZA" class="nav-logo-img" width="320" height="60" fetchpriority="high" decoding="async" loading="eager">
          <?php endif; ?>
        </a>
      </div>
      ...
      <div class="header-end">
        ...
        <div class="header-actions">
          ...
          <a href="<?php echo e(route('login')); ?>" class="nav-cta" style="text-decoration:none;display:inline-flex;align-items:center;justify-content:center">Login</a>
        </div>
      </div>
    </div>
  </div>
...
<script>
  ...
  (function () {
    ...
    var postUrl = <?php echo json_encode(route('landing.get-started'), 15, 512) ?>;
...
<?php /**PATH /media/supreme/627ADCCA7ADC9BDB/Users/Ayiik/Documents/Code/MyBidhaa/School Management/resources/views/frontEnd/landing/kuzza_landing.blade.php ENDPATH**/ ?>