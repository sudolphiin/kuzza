                ...
                <?php if(Auth::user()->is_saas == 0): ?>
                    <div class="row row-gap-24">
                        ...
                        <?php if(userPermission('number-of-parent')): ?>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                            <a href="<?php echo e(route('parent-list')); ?>" class="d-block">
...
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /media/supreme/627ADCCA7ADC9BDB/Users/Ayiik/Documents/Code/MyBidhaa/School Management/resources/views/backEnd/dashboard.blade.php ENDPATH**/ ?>