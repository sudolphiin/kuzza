    ...
    <div class="container-fluid p-0">
        <div class="white-box">
            ...
            <?php if($cart_items && count($cart_items) > 0): ?>
                <form method="POST" action="<?php echo e(route('parent-recommended-items-cart.checkout')); ?>" id="recommended-items-checkout-form">
                    <?php echo csrf_field(); ?>
                </form>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $cart_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
                                        <input type="checkbox" name="item_ids[]" value="<?php echo e($item->id); ?>" class="item-checkbox" form="recommended-items-checkout-form">
                                    </td>
                                    <td>
...
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/kuzza/resources/views/backEnd/parentPanel/recommended_items_cart.blade.php ENDPATH**/ ?>