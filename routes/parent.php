...
Route::group(['middleware' => ['XSS', 'subdomain', 'fees_due_check']], function () {
    ...
    Route::group(['middleware' => ['ParentMiddleware']], function () {
        ...
        // School Recommended Items Routes
        ...
        Route::group(['prefix' => 'procurement', 'as' => 'parent.procurement.'], function () {
            Route::get('dashboard', 'Parent\SmProcurementController@procurementDashboard')->name('dashboard')->middleware('userRolePermission:parent-procurement-dashboard');
            Route::get('book-list', 'Parent\SmProcurementController@bookList')->name('book-list')->middleware('userRolePermission:parent-procurement-book-list');
            Route::get('mybidhaa-link', 'Parent\SmProcurementController@myBidhaaLink')->name('mybidhaa-link')->middleware('userRolePermission:parent-procurement-mybidhaa-link');
            Route::get('product-list', 'Parent\SmProcurementController@productList')->name('product-list')->middleware('userRolePermission:parent-procurement-product-list');
            Route::post('buy-product', 'Parent\SmProcurementController@buyProduct')->name('buy-product')->middleware('userRolePermission:parent-procurement-buy-product');
            Route::post('upload-product-list', 'Parent\SmProcurementController@uploadProductList')->name('upload-product-list')->middleware('userRolePermission:parent-procurement-upload-product-list');
        });
