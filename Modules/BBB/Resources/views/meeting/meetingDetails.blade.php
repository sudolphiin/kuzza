...
@section('mainContent')
    ...
    <section class="sms-breadcrumb mb-20">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1>@lang('bbb::bbb.meeting_details')</h1>
                <div class="bc-pages">
                    <a href="{{route('dashboard')}}">@lang('common.dashboard')</a>
                    <a href="#">@lang('bbb::bbb.bbb')</a>
                    <a href="#">@lang('bbb::bbb.virtual_meeting')</a>
                    <a href="#">@lang('bbb::bbb.meeting_details')</a>
                </div>
            </div>
        </div>
    </section>
  ...
  <tr>
                                    <td>{{ $sl++ }} </td>
                                    <td class="propertiesname">@lang('bbb::bbb.start_join_before')</td>
                                    <td>@if($localMeetingData->time_start_before==null) 10  @else {{ $localMeetingData->time_start_before }} @endif Min</td>
                                </tr>
                            ...
                            @endif
                                ...
                                {{--                                <tr>--}}
                                {{--                                    <td>{{ $sl++ }} </td>--}}
                                {{--                                    <td class="propertiesname">{{__('bbb.Logo')}}  </td>--}}
