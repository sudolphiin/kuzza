            ...
            <div class="row mb-40">
                <div class="col-lg-12">
                    ...
                    <div class="white-box">
                        ...
                        @if (userPermission('jitsi.meeting.reports.show'))
                                    ...
                                    <div class="primary_datepicker_input">
                                        <div class="no-gutters input-right-icon">
                                            <div class="col">
                                                <div class="">
                                                    <input class="primary_input_field  primary_input_field date form-control "
                                                        id="toDate" type="text" name="to_time"
                                                        value="{{ isset($to_time) ? Carbon\Carbon::parse($to_time)->format('m/d/Y') : '' }}"
                                                        readonly>

                                                </div>
                                            </div>
                                            <button class="btn-date" data-id="#toDate" type="button">
                                                <label class="m-0 p-0" for="toDate">
                                                    <i class="ti-calendar" id="start-date-icon"></i>
                                                </label>
                                            </button>
                                        </div>
    ...
    <script>
        $(document).ready(function() {
            $(document).on('change', '.user_type', function() {
                ...
                $.get('{{ route('jitsi.user.list.user.type.wise') }}', {
                    user_type: userType
                }, function(res) {
