...
namespace Modules\Certificate\QrCode;

use BadMethodCallException;
use Modules\Certificate\QrCode\BaconQrCode\Writer;
use Modules\Certificate\QrCode\BaconQrCode\Encoder\Encoder;
use Modules\Certificate\QrCode\DataTypes\DataTypeInterface;
use Modules\Certificate\QrCode\BaconQrCode\Renderer\Color\Rgb;
use Modules\Certificate\QrCode\BaconQrCode\Renderer\Color\Alpha;
use Modules\Certificate\QrCode\BaconQrCode\Renderer\Eye\ModuleEye;
use Modules\Certificate\QrCode\BaconQrCode\Renderer\Eye\SquareEye;
use Modules\Certificate\QrCode\BaconQrCode\Renderer\ImageRenderer;
use Modules\Certificate\QrCode\BaconQrCode\Exception\WriterException;
use Modules\Certificate\QrCode\BaconQrCode\Renderer\Eye\EyeInterface;
use Modules\Certificate\QrCode\BaconQrCode\Renderer\Module\DotsModule;
use Modules\Certificate\QrCode\BaconQrCode\Common\ErrorCorrectionLevel;
use Modules\Certificate\QrCode\BaconQrCode\Renderer\RendererStyle\Fill;
use Modules\Certificate\QrCode\BaconQrCode\Renderer\Eye\SimpleCircleEye;
use Modules\Certificate\QrCode\BaconQrCode\Renderer\Module\SquareModule;
use Modules\Certificate\QrCode\BaconQrCode\Renderer\Color\ColorInterface;
use Modules\Certificate\QrCode\BaconQrCode\Renderer\Image\EpsImageBackEnd;
use Modules\Certificate\QrCode\BaconQrCode\Renderer\Image\SvgImageBackEnd;
use Modules\Certificate\QrCode\BaconQrCode\Renderer\RendererStyle\EyeFill;
use Modules\Certificate\QrCode\BaconQrCode\Renderer\Module\ModuleInterface;
use Modules\Certificate\QrCode\BaconQrCode\Renderer\Module\RoundnessModule;
use Modules\Certificate\QrCode\BaconQrCode\Renderer\RendererStyle\Gradient;
use Modules\Certificate\QrCode\BaconQrCode\Exception\InvalidArgumentException;
use Modules\Certificate\QrCode\BaconQrCode\Renderer\Image\ImagickImageBackEnd;
use Modules\Certificate\QrCode\BaconQrCode\Renderer\RendererStyle\GradientType;
use Modules\Certificate\QrCode\BaconQrCode\Renderer\Image\ImageBackEndInterface;
use Modules\Certificate\QrCode\BaconQrCode\Renderer\RendererStyle\RendererStyle;
...
class Generator
{
     ...
     * @param Modules\Certificate\QrCode\boolean|bool $absolute
     * @return Generator
     */
    ...
    protected function formatClass(string $method): string
    {
        ...
        $class = "Modules\Certificate\QrCode\DataTypes\\".$method;
