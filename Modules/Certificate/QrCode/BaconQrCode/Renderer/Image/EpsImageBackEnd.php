...
namespace Modules\Certificate\QrCode\BaconQrCode\Renderer\Image;

use Modules\Certificate\QrCode\BaconQrCode\Exception\RuntimeException;
use Modules\Certificate\QrCode\BaconQrCode\Renderer\Color\Alpha;
use Modules\Certificate\QrCode\BaconQrCode\Renderer\Color\Cmyk;
use Modules\Certificate\QrCode\BaconQrCode\Renderer\Color\ColorInterface;
use Modules\Certificate\QrCode\BaconQrCode\Renderer\Color\Gray;
use Modules\Certificate\QrCode\BaconQrCode\Renderer\Color\Rgb;
use Modules\Certificate\QrCode\BaconQrCode\Renderer\Path\Close;
use Modules\Certificate\QrCode\BaconQrCode\Renderer\Path\Curve;
use Modules\Certificate\QrCode\BaconQrCode\Renderer\Path\EllipticArc;
use Modules\Certificate\QrCode\BaconQrCode\Renderer\Path\Line;
use Modules\Certificate\QrCode\BaconQrCode\Renderer\Path\Move;
...
final class EpsImageBackEnd implements ImageBackEndInterface
{
    ...
    public function new(int $size, ColorInterface $backgroundColor) : void
    {
        $this->eps = "%!PS-Adobe-3.0 EPSF-3.0\n"
            . "%%Creator: Modules\Certificate\QrCode\BaconQrCode\n"
